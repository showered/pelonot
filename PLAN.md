...
**The owner's inbox is empty and item 1 is gone from this list for the first
time in three sittings.** The redeploy happened, `./web/check-deployed.sh`
confirms all seven files match, and **the command is now written down**:
`git push` (17.16.2, in CLAUDE.md). What is still true is that the top of this
