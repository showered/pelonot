...
| **25.3** The overlay's stand/sit cue | The owner's own idea and the part he was specific about. The rule is written (25.3.1): animate for the *transition*, then go quiet. Needs the bike and a film to judge |
| **25.4.1** Positions across the rest of the library | Ten of 72 classes prescribe one. A catalogue edit, wanted after 25.3 so the effect can be seen |
...
| 24 | Household social — the tier that needs no cloud | 🔶 **24.1 and 24.2 built and observed** — the per-class board, and the household's week on the dashboard with streaks and a per-profile opt-out. Riding against a housemate (24.3) remains |
| 25 | Out of the saddle | 🔶 **The field, the ride screen and the spoken coach are done and observed (25.1, 25.2).** The overlay's cue (25.3) is the part the owner cared most about and needs the bike and a film; the rest of the library (25.4) remains |
