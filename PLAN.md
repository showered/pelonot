...
### Latest session — 13 August 2026 (forty-fourth sitting): a promise nobody was holding the library to
...
### The sitting before — 13 August 2026 (forty-third sitting): the way back down, and the ride facts the wire never carried
...
tenth sitting running, because none of it is work: what stands between the QR
...
reason. What moved this sitting is not on this list at all: **the class library
was breaking a rule the owner themselves produced**, and the rule was enforced on
neither surface it applies to (23.2.8). Both classes are fixed and both fixes
were watched.

**The lesson worth carrying forward is where the lead came from.** It was not on
this list; it came from `STATUS.md` item 7 asking to be read *"as evidence about
the other rules marked not tested"*. There is now one such rule left in
`classlibrary/README.md` — **R8** — and 23.2.8f says what it would cost and why
it is deliberately not built. When this list is all owner-and-bike, **the
