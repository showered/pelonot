...
### Latest session — 13 August 2026 (forty-third sitting): the way back down, and the ride facts the wire never carried
...
### The sitting before — 13 August 2026 (forty-second sitting): the way out of the cloud, and why deleting the copy has to stop the backing up
...
ninth sitting running, because none of it is work: what stands between the QR
fix and the owner is one deploy, and what stands between the *journey* and
anybody is the mailer.** What moved this sitting is **the way back down**:
15.3.2 is built, so the cloud stops being write-only and *backup* becomes a word
the app is entitled to. It is **not ticked**, and item 0 below is the reason —
one throwaway sign-in is all that stands between it and the house rule.
