...
(new), **22.2.6**, **25.1** and **25.2** (both new). 393 JVM tests, 0 failures.
**That clears the last two items off the first real ride's snag list.**
...
| 25 | Out of the saddle | 🔶 **The field and the ride screen are done and observed (25.1, 25.2).** The overlay's cue (25.3) is the part the owner cared most about and needs the bike; the spoken coach (25.2.3) and the rest of the library (25.4) remain |
