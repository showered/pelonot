...
klass("END-01", "Zone 2 Steady", ENDURANCE,
      WU5, hold(600, 2, BRISK), CD5)

klass("END-02", "Cadence Ladder", ENDURANCE,
      WU5,
...
klass("SWT-01", "Sweet Spot 5 + 4", SWEET_SPOT,
      WU5,
      hold(300, 4, BRISK), hold(180, 1, EASY), hold(240, 4, BRISK),
      CD3)

klass("SWT-02", "Sweet Spot Over/Under", SWEET_SPOT,
      WU5,
      alternate(4, 120, 4, BRISK, 60, 3, BRISK),
      CD3)

klass("SWT-03", "Sweet Spot 3×5", SWEET_SPOT,
      WU5,
      sets(3, on=300, zone=4, cadence=STEADY, off=180),
      CD4)

klass("SWT-04", "Sweet Spot Build", SWEET_SPOT,
      WU5,
...
klass("SWT-06", "Sweet Spot Descending", SWEET_SPOT,
      WU5,
      ladder([360, 300, 240], zone=4, cadence=FAST, rests=[180, 180]),
      CD4)

klass("SWT-07", "Sweet Spot 3×8", SWEET_SPOT,
      WU8,
      sets(3, on=480, zone=4, cadence=STEADY, off=300),
      CD3)

klass("SWT-08", "Over/Under, Two Sets", SWEET_SPOT,
      WU5,
...
klass("SWT-09", "Big Gear / Fast Legs", SWEET_SPOT,
      WU8,
...
klass("SWT-10", "Sweet Spot Ladder", SWEET_SPOT,
      WU8,
      ladder([240, 360, 480, 360], zone=4, cadence=BRISK, rests=[180, 180, 240]),
      CD3)

klass("SWT-11", "Sweet Spot 3×12", SWEET_SPOT,
      WU8,
      sets(3, on=720, zone=4, cadence=STEADY, off=360),
      CD4)

klass("SWT-12", "Sweet Spot Endurance", SWEET_SPOT,
      WU8,
...
klass("SWT-13", "Low Cadence Sweet Spot 4-5-6", SWEET_SPOT,
      WU5,
...
klass("THR-10", "Threshold 5×4, Shrinking Rest", THRESHOLD,
      WU8,
...
klass("THR-11", "Threshold 4×9", THRESHOLD,
      WU5,
      sets(4, on=540, zone=4, cadence=FAST, off=300),
      CD4)

klass("THR-12", "Threshold Mixed", THRESHOLD,
      WU5, primers(2, 5, FAST, on=30, off=60),
...
klass("VMX-01", "VO2 2×3", VO2,
      WU5, primers(2, 5, FAST, on=30, off=60),
      sets(2, on=180, zone=5, cadence=FAST, off=180),
      CD3)

klass("VMX-02", "VO2 30/30", VO2,
...
klass("CLB-06", "Climb and Attack", CLIMBS,
...
klass("CLB-10", "Big Mountain", CLIMBS,
      WU5, primers(2, 5, CLIMB, on=30, off=60),
...
klass("SPR-01", "Tabata 2×8", SPRINTS,
...
klass("SPR-02", "Sprint 30/30", SPRINTS,
...
klass("SPR-03", "Sprint Ladder", SPRINTS,
...
klass("SPR-04", "Tabata 3×8", SPRINTS,
...
klass("SPR-05", "Sprints, Three Ways", SPRINTS,
      WU5, primers(3, 6, SURGE, on=20, off=60),
      sets(8, on=20, zone=6, cadence=SURGE, off=10),
      hold(180, 1, EASY),
...
klass("SPR-06", "Sprint Endurance", SPRINTS,
      WU5, primers(3, 6, SURGE, on=20, off=60),
      hold(180, 2, BRISK),
      sets(8, on=20, zone=6, cadence=SURGE, off=10, trailing=True),
      hold(240, 2, BRISK),
